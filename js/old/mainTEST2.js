...
var brodGran = {elem: document.getElementById('brodGran'), item: ""};
var brodGlen = {elem: document.getElementById('brodGlen'), item: ""};
var wintGran = {elem: document.getElementById('wintGran'), item: ""};
var wintGlen = {elem: document.getElementById('wintGlen'), item: ""};
...
$(document).ready(function () {
	$(document).keydown(function(key) {
		...
		if(inRangeCheck(rick, brodGran) < 30) {
			switch()
		}
